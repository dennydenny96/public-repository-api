...
{
    public class EmployeeAdd : BaseService
    {
        public EmployeeAdd(HttpContext httpContext) : base(httpContext)
        {
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (tuple.Item1)
                    {
                        ...
                        retVal = this.ProcessResult(Helper.GetEmployeesListHelper.EmployeeAdd(data));
                    }
                    else
                    {
                        retVal = tuple.Item2;
