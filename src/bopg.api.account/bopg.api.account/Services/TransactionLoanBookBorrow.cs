...
{
    public class TransactionLoanBookBorrow : BaseService
    {
        public TransactionLoanBookBorrow(HttpContext httpContext) : base(httpContext)
        {
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (tuple.Item1)
                    {
                        ...
                        retVal = this.ProcessResult(Helper.TransactionsLoanBookHelper.TransactionLoanBookBorrow(data));
                    }
                    else
                    {
                        retVal = tuple.Item2;
