...
{
    public class MasterLoanBookList : BaseService
    {
        public MasterLoanBookList(HttpContext httpContext) : base(httpContext)
        {
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (tuple.Item1)
                    {
                        ...
                        retVal = this.ProcessResult(Helper.MasterLoanBookHelper.MasterLoanBookList(data));
                    }
                    else
                    {
                        retVal = tuple.Item2;
