...
{
    public class UserLoginAdd : BaseService
    {
        public UserLoginAdd(HttpContext httpContext) : base(httpContext)
        {
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (tuple.Item1)
                    {
                        ...
                        retVal = this.ProcessResult(Helper.UserLoginHelper.UserLoginAdd(data));
                    }
                    else
                    {
                        retVal = tuple.Item2;
