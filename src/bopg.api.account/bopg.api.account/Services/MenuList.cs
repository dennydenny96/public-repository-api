...
{
    public class MenuList : BaseService
    {
        public MenuList(HttpContext httpContext) : base(httpContext)
        {
        }
        ...
        public override string GetResponse()
        {
            ...
            try
            {
                ...
                {
                    var tuple = this.ParsingJSONStringInput<Model.MenuList>();
                    if (tuple.Item1)
                    {
                        var data = tuple.Item3;

                        retVal = this.ProcessResult(Helper.MenuListHelper.MenuList(data));
                    }
                    else
                    {
                        retVal = tuple.Item2;
